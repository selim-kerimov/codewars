 ...
 * effort. Since this is the wild west, with dreadful weather and not much water, it's important to 
 ...
 * is not reasonable, better stay to the same place! So the task is to give to the man a simplified 
...
function dirReduc(arr){
  ...
  while (index !== arr.length) {
    if (arr[index] == oppositeDirs[arr[index + 1]]) {
      arr.splice(index, 2)
      index = 0
    }
    else index++
...
console.log(dirReduc(["NORTH", "SOUTH", "SOUTH", "EAST", "WEST", "NORTH", "WEST"])) // should return: ["WEST"]
console.log(dirReduc(["NORTH", "WEST", "SOUTH", "EAST"])) // should return: ["NORTH", "WEST", "SOUTH", "EAST"]
console.log(dirReduc(["NORTH", "SOUTH", "EAST", "WEST", "EAST", "WEST"])) // should return: []